...
//https://cloud.appwrite.io/console/project-65034b5d5c5f7eb2aea8/overview/platforms
...
function showScore(){
    getUserId().then(userId => {
        database.listDocuments(
            ...
            const highScoreElement = getElementById('highscore')
            highScoreElement.textContent = response.documents[0]
        })
    })
}
